...
# ATTENTION: 
Do it on a USB Stick or it will have serious consequences (You will probably not be able to unlock your Device again)!!! 

Lite Version (rickrollstick_LITE.bat)
...
5) Download cmdmp3 made by Jim Lawless from https://github.com/jimlawless/cmdmp3 or https://jiml.us/posts/cmdmp3/ or direct download from my Repository
...
Full Version (rickrollstick.bat)
1) Create an directory with the Name "files" on an USB Stick.
...
---- HOW TO DEACTIVATE ----
Simply remove "rickrollsticklistener.vbs" from the autostart section in task manager.
...
# Changelog:
Updated hash for nircmd and cmdmp3
Uploaded cmdmp3 URL to my Repo, or you can use his binary
